...
export default class Product extends Component {
  ...
  getMaterial = async () => {
    ...
    this.debounceTimeout = setTimeout(async () => {
      try {
        ...
        const { data } = await FolderWickelfalz6seiten.digiPrintMaterial(this.state.initialValues)
        let newData = []
        data.data.forEach((element) => {
          newData = [
            ...newData,
        ...
        const materialSelected = data.data.filter((x) => x.key === "120g Color Copy")
  ...
  handleSubmit = async () => {
    ...
    try {
      ...
      const { data } = await FolderWickelfalz6seiten.record(this.state.initialValues, this.loaderPercentage)
            ...
            <>
              ...
              >
                <div className="product-details">
                  ...
                  <div className="details__Endformat">
                    <FormGroup className="product-details__form-group" style={{ width: "100%" }}>
                  ...
                  <div className="details__Druck">
                    <FormGroup className="product-details__form-group">
                      <ControlLabel style={{ float: "left" }}>Druck:</ControlLabel>
                      <SelectPicker
                        searchable={false}
                        style={{ width: "100%", float: "right" }}
                  ...
                  <div className="details__Farbigkeit">
                    <FormGroup className="product-details__form-group">
                      <ControlLabel style={{ float: "left" }}>Farbigkeit:</ControlLabel>
                      <SelectPicker
                        searchable={false}
                        style={{ width: "100%", float: "right" }}
                        onChange={(e) => this.onChange("colorful", e)}
                        className="details-Farbigkeit"
                        name="colorful"
                        data={colorful}
                        required
                  ...
                  <div className="details__Zellophan">
                    <FormGroup className="product-details__form-group">
                  ...
                  <div className="details__Material">
                    {materialShow ? (
                      <FormGroup className="product-details__form-group">
                        <ControlLabel className="details-Material-label" style={{ float: "left" }}>
                          Material:
                        </ControlLabel>
                        <SelectPicker
                          style={{
                          ...
                          name="materialId"
                          className="details-Material details-Material-select"
                          data={material}
                          required
