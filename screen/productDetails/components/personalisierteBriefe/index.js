                ...
                <div className="data-upload__content">
                  ...
                  <div className="data-upload__button">
                    <div
                      ...
                      className="data-upload__button-name"
                    >
                      ...
                      <div>
                        <label style={{ zIndex: "999" }} className="custom-file-upload main1-lab-bargozari-ax">
                          <div>
                            <input
                              name="file1"
                              type="file"
                              ...
                              required
                              // accept="image/*"
                              onChange={(e) => this.handleChangeFileOne(e)}
                            />
                          </div>
                        </label>
                      </div>
                    ...
                    <div className="data-upload__button">
                      <div
                        ...
                        className="data-upload__button-name"
                      >
                        {loading1 ? <Loader center content="loading" /> : ""}
                        {image2 ? (
                          <i
                            style={
                              {
                          ...
                          <label className="custom-file-upload main1-lab-bargozari-ax">
                            <div>
                              <input
                                ...
                                id="file"
                                // accept="image/*"
                                onChange={(e) => this.handleChangeFileTwo(e)}
                              />
                            </div>
                          </label>
                        </div>
