...
export default class gride extends Component {
  state = {
    ...
    initialValue: {
      ...
      file2: "",
      // product:
      //   this.props.props.match.params.name === "Anfrage"
      //     ? ""
      //     : this.props.props.match.params.name,
      description: ""
    },
    formError: {},
    redirect: false,
  ...
  handleSubmit = async () => {
    try {
      ...
      const { status } = await Support.Complaint(this.state.initialValue, this.loaderPercentage)
      if (status === 200) {
        this.open("success", "Bestätigung", "Ihre Re­kla­ma­ti­on wurde erfolgreich gesendet.")
        router.push("/")
      }
    } catch (error) {
      console.error(error)
            ...
            <div className="payment-measurement">
              <div className="payment-section anfrageSection">
                <div className="payment__methods-container">
                  <div className="payment-title padding-btm-0">Re­kla­ma­ti­on</div>
                  ...
                  <div className="data-upload__describe-area data-upload__describe-area-resp">
                    <textarea name="description" onChange={(e) => this.onChange("description", e)} rows="6" cols="70"></textarea>
                  </div>
                ...
                >
                  ...
                  >
                    <div className="payment-title payment-title-responsive">Kontaktdaten</div>
